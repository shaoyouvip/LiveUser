/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 87c7d40ea8df398af2aaeb8e46cb57d3)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VISITOR_HMAC_SECRET">> {}
}
